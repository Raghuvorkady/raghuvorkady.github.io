...
Full-stack Software Development Engineer with 1.5+ years SDE experience (4 years IT overall), specializing in backend (Java, Spring Boot, SAP CAP), frontend (SAPUI5, TypeScript), and test automation. Passionate about building scalable, efficient applications and solving complex technical problems.
...
* Implemented State Management using Provider pattern, optimizing performance and reducing widget rebuild cycles  
* Created reusable View and Model components following MVC architecture for maintainability and scalability  
...
* Led refactoring of an automated test suite of 100+ files, significantly improving stability, readability, and debugging efficiency.  
* Received appreciation from my development manager for my exceptional work in the team.  
* Received Head of Support recognition within six months for exceptional technical contributions to BTP Core Platform Services.